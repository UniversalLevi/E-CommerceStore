    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="p-6 rounded-lg border" style={{ backgroundColor: colors.secondary, borderColor: colors.border || colors.primary + '20' }}>
            <h2 className="text-xl font-semibold mb-4" style={{ color: colors.primary }}>
              Order Summary
            </h2>
            ...
            <div className="border-t pt-4" style={{ borderColor: colors.border || colors.primary + '20' }}>
