...
export default function Header({ storeSlug, storeName, onCartClick }: HeaderProps) {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      window.location.href = `https://${storeSlug}.eazydropshipping.com?search=${encodeURIComponent(searchQuery)}`;
    }
  };
  ...
  return (
    <header
      ...
      style={{
        ...
        boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.4), 0 0 20px rgba(0, 0, 0, 0.2)',
      }}
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-lg mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg border focus:outline-none focus:ring-2 transition-all placeholder:opacity-50"
                style={{
          ...
          <div className="hidden md:flex items-center gap-4">
            <button
              ...
              className="relative p-2 rounded-lg transition-all duration-300 cursor-pointer hover:scale-110 hover:rotate-3"
              style={{ 
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <button
              ...
              style={{ color: colors.primary, backgroundColor: 'rgba(26, 26, 26, 0.8)' }}
            >
