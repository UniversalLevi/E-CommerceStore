  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 slide-up">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Product Images */}
        <div>
          <div className="aspect-square rounded-lg overflow-hidden mb-4 bg-black border-2 neon-border" style={{ borderColor: colors.primary }}>
            ...
            <div className="grid grid-cols-4 gap-2">
              {product.images.map((img, idx) => (
                <button
                  ...
                  className={`aspect-square rounded-lg overflow-hidden border-2 transition-all neon-hover-glow ${
                    selectedImage === idx ? 'neon-border' : 'border-transparent'
                  }`}
                  style={{ 
        ...
        {/* Product Info */}
        <div>
          <h1 className="text-3xl md:text-4xl font-bold mb-4 neon-glow slide-in-right" style={{ color: colors.primary }}>
            {product.title}
          </h1>

          <div className="mb-6">
            <p className="text-3xl font-bold neon-glow" style={{ color: colors.accent }}>
          ...
          {product.variants && product.variants.length > 0 && (
            <div className="mb-6">
              ...
              <select
                ...
                className="w-full px-4 py-2 rounded-lg border neon-input bg-black/50"
                style={{
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-4 py-2 rounded-lg border neon-button"
                style={{
                  borderColor: colors.border || colors.primary + '50',
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex-1 px-6 py-4 rounded-lg font-medium transition-all neon-button flex items-center justify-center gap-2 border-2 cursor-pointer"
              style={{
            ...
            <button
              ...
              className="flex-1 px-6 py-4 rounded-lg font-bold text-black transition-all neon-button cursor-pointer"
              style={{ 
