...
export default function Checkout({ storeSlug, currency }: CheckoutProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 slide-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="p-6 rounded-lg border neon-border" style={{ 
            ...
            <div className="border-t pt-4" style={{ borderColor: colors.border || colors.primary + '50' }}>
              <div className="flex justify-between font-bold text-lg">
                <span style={{ color: colors.text }}>Total:</span>
                  <span className="neon-glow" style={{ color: colors.accent }}>{formatPrice(getTotalPrice())}</span>
              </div>
            </div>
          </div>
        </div>
