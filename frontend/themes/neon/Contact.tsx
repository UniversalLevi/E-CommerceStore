...
export default function Contact({ storeSlug, storeName }: ContactProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 slide-up">
      <h1 className="text-4xl font-bold mb-8 neon-glow" style={{ color: colors.primary }}>
        Contact Us
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          ...
          <div className="space-y-4">
            <div>
              <p className="font-semibold mb-2" style={{ color: colors.primary }}>Email</p>
              <p style={{ color: colors.text + 'CC' }}>support@{storeName.toLowerCase().replace(/\s+/g, '')}.com</p>
            </div>
            <div>
              <p className="font-semibold mb-2" style={{ color: colors.primary }}>Response Time</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full px-6 py-3 rounded-lg font-bold text-black neon-button transition-all"
            style={{ 
