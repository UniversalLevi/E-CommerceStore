    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          ...
          <p className="mb-6 animate-fadeIn relative z-10" style={{ color: '#e0e7ff', opacity: 0.9 }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full px-6 py-3 rounded-xl font-medium text-white transition-all duration-300 hover:scale-105 hover:shadow-2xl relative overflow-hidden group relative z-10"
            style={{ 
