...
export default function Home({ storeSlug, storeName, products, currency }: HomeProps) {
  ...
  return (
    <div>
      ...
      <section className="py-16 relative z-10" style={{ backgroundColor: colors.background }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-8 text-center animate-fadeIn relative z-10" style={{ 
