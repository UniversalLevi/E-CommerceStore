...
export default function Checkout({ storeSlug, currency }: CheckoutProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 vintage-fade">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-1">
          <div className="p-8 border-2 vintage-card" style={{ 
            borderColor: colors.border || colors.primary 
          }}>
            <h2 className="text-xl font-semibold mb-6" style={{ color: colors.primary }}>
              Order Summary
            ...
            <div className="border-t-2 pt-4" style={{ borderColor: colors.border || colors.primary }}>
