...
export default function Header({ storeSlug, storeName, onCartClick }: HeaderProps) {
  ...
  return (
    <header
      className="sticky top-0 z-50 border-b backdrop-blur-lg bg-opacity-90"
      style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-lg mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg border backdrop-blur-sm"
                style={{
          ...
          <div className="hidden md:flex items-center gap-4">
            <button
              ...
              className="relative p-2 rounded-lg hover:opacity-80 transition-all hover:scale-110 cursor-pointer"
              style={{ color: colors.primary }}
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <button
              onClick={handleCartClick}
              className="w-full flex items-center justify-between p-3 rounded-lg hover:opacity-80 transition-opacity cursor-pointer"
              style={{ color: colors.primary, backgroundColor: colors.secondary + '80' }}
              aria-label="Open cart"
            >
