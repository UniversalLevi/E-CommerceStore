      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-lg mx-8">
            <div className="relative w-full">
              <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5" style={{ color: colors.text + '80' }} />
              <input
                type="text"
                placeholder="Search products..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-12 pr-4 py-3 rounded-sm border"
                style={{
          ...
          <div className="hidden md:flex items-center gap-6">
            <button
              ...
              className="relative p-2 rounded-sm hover:opacity-80 transition-opacity cursor-pointer"
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <button
              onClick={handleCartClick}
              className="w-full flex items-center justify-between p-3 rounded-sm hover:opacity-80 transition-opacity cursor-pointer"
